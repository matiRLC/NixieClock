...
#define BAUD 2000000 // I am actually testing with 2Mbps
...
#define NUM_CHANNELS 1 // WE ARE TRYING WITH 2 CHANNELS SIMULTANEOUS
...
void loop() {    
    ...
    for(i = 0, j = 0; i < NUM_CHANNELS; i++, j+= 2) {
        // every element at parsed[] is a 16bit number, sending MSB first
